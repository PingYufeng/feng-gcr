...
docker pull kubeflownotebookswg/centraldashboard:v1.6.1
docker pull kubeflownotebookswg/poddefaults-webhook:v1.6.1
docker pull kubeflownotebookswg/kfam:v1.6.1
docker pull kubeflownotebookswg/profile-controller:v1.6.1
docker pull kubeflownotebookswg/volumes-web-app:v1.6.1
docker pull kubeflownotebookswg/tensorboard-controller:v1.6.1
docker pull kubeflownotebookswg/tensorboards-web-app:v1.6.1

docker pull kubeflownotebookswg/notebook-controller:v1.6.1
docker pull kubeflownotebookswg/jupyter-web-app:v1.6.1
...
docker pull kserve/alibi-explainer:latest
